    ...
    <div className="grid grid-cols-12 gap-8">
      ...
      <div className="col-span-12 lg:col-span-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Income Card */}
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-xl hover:bg-white/15 transition-all duration-300">
          ...
          <div className="flex flex-wrap justify-between items-center mb-8">
            <div>
              ...
              <div className="flex items-center gap-3">
                <span className="text-4xl font-bold text-white">$9,580.00</span>
            ...
            <div className="flex bg-black/20 rounded-full p-1 border border-white/10">
              <button className="px-4 py-1.5 rounded-full text-sm font-medium text-gray-300 hover:text-white transition-colors">{t.common.week}</button>
              <button className="px-4 py-1.5 rounded-full text-sm font-bold bg-white/20 shadow-sm text-white border border-white/10 backdrop-blur-md">{t.common.month}</button>
              <button className="px-4 py-1.5 rounded-full text-sm font-medium text-gray-300 hover:text-white transition-colors">{t.common.year}</button>
            </div>
          </div>
            ...
            {[65, 60, 55, 58, 68, 64, 90, 75, 72, 78, 95, 98].map((height, i) => {
              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center group relative">
                  {isSelected && (
                    <div className="absolute -top-12 left-1/2 -translate-x-1/2 bg-white/20 backdrop-blur-md border border-white/20 text-white text-xs py-1 px-2 rounded-lg mb-2 whitespace-nowrap z-10 shadow-lg">
                  ...
                  <div className="w-full bg-black/20 rounded-t-xl relative h-full overflow-hidden border border-white/5">
                    ...
                    <div 
                      style={{ height: `${height}%` }} 
                      className={`absolute bottom-0 w-full rounded-t-xl transition-all duration-500 ${isSelected ? 'bg-white/90 shadow-[0_0_20px_rgba(255,255,255,0.5)]' : 'bg-white/30 group-hover:bg-white/40'}`}
                    ></div>
                  </div>
            ...
            <div className="flex gap-3">
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-9 pr-4 py-2 rounded-full border border-white/10 bg-black/20 text-white text-sm focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-white/30 placeholder-gray-500 transition-all"
                />
              </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-xl">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="text-center mt-1 text-xs text-white bg-emerald-500 w-8 rounded ml-[70%] shadow-lg">75%</div>
            </div>
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="font-medium text-white">{t.dashboard.goals.emergencyFund}</span>
                <span className="text-gray-300">$7,500 / $15,000</span>
              </div>
              <div className="relative w-full h-2 bg-black/20 rounded-full overflow-hidden">
              ...
              <div className="text-center mt-1 text-xs text-white bg-blue-500 w-8 rounded ml-[45%] shadow-lg">50%</div>
            </div>
            <div>
              <div className="flex justify-between text-sm mb-1">
                <span className="font-medium text-white">{t.dashboard.goals.vacation}</span>
                <span className="text-gray-300">$5,000 / $2,000</span>
              </div>
              <div className="relative w-full h-2 bg-black/20 rounded-full overflow-hidden">
              ...
              <div className="text-center mt-1 text-xs text-white bg-amber-500 w-8 rounded ml-[20%] shadow-lg">25%</div>
            </div>
          </div>
        </div>
